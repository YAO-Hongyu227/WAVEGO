        ...
        <section id="buttons">
            <div id="controls" class="control-container">
                <table>
                    ...
                    <td align="center"><input type="text" id="ClimbValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="ClimbsetValAndFetch();">Free Climb (direction)</button>
                    
                    </td>
                    
                    <script>
                    function ClimbsetValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('ClimbValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=freeclimb&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <td align="center"><input type="text" id="dirValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="DirsetValAndFetch();">Walk Direction</button>
                    
                    </td>
                    
                    <script>
                    function DirsetValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('dirValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=walkdirection&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <td align="center"><input type="text" id="directionValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="DirectionsetValAndFetch();">Trot Direction</button>
                    
                    </td>
                    
                    <script>
                    function DirectionsetValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('directionValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=trotdirection&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=stepiterate&val=1&cmd=0');">step iterate +0.01 </button></td>
                        <td align="center"></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=stepiterate&val=-1&cmd=0');">step iterate -0.01 </button></td>
                    </tr>

                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=stepdelay&val=1&cmd=0');">step delay +1 </button></td>
                        <td align="center"></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=stepdelay&val=-1&cmd=0');">step delay -1 </button></td>
                    </tr>

                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=rightbias&val=1&cmd=0');">Right Leg Bias +0.01 </button></td>
                        <td align="center"></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=rightbias&val=-1&cmd=0');">Right Leg Bias -0.01 </button></td>
                    </tr>

                    <td align="center"><input type="text" id="clearanceValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="WALKHEIGHTValAndFetch();">WALK LIFT</button>
                    ...
                    <td align="center"><input type="text" id="heightValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="STANDHEIGHTValAndFetch();">WALK HEIGHT</button>
                    
                    </td>
                    
                    <script>
                    function STANDHEIGHTValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('heightValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=standheight&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=rlbbias&val=1&cmd=0');">RLB Bias +0.01</button></td>
                        <td align="center"></td>                        
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=rlbbias&val=-1&cmd=0');">RLB Bias -0.01</button></td>
                    </tr>
                    ...
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=offsetx&val=1&cmd=0');">OFFEST X +0.1 </button></td>
                        <td align="center"></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=offsetx&val=-1&cmd=0');">OFFEST X -0.1 </button></td>
                    </tr>
                    
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=offsetz&val=1&cmd=0');">OFFEST Z +0.1 </button></td>
                        <td align="center"></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=offsetz&val=-1&cmd=0');">OFFEST Z -0.1 </button></td>
                    </tr>

                    <td align="center"><input type="text" id="offcycleValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="OffcycleValAndFetch();">OFFSET CYCLEINPUT * 0.001 (875 = 0.875)</button>
                    </td>
                    <script>
                    function OffcycleValAndFetch() {
                        var userValue = document.getElementById('offcycleValue').value;
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            fetch(document.location.origin + '/control?var=offsetcycle&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <td align="center"><input type="text" id="BuzzertimeValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="BuzzertimeValAndFetch();">BUZZER TIME</button>
                    
                    </td>
                    
                    <script>
                    function BuzzertimeValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('BuzzertimeValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=buzzeron&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
                    ...
                    <td align="center"><input type="text" id="BuzzerValue" placeholder="Enter a value">
                    <td align="center"><button class="button button4" id="stayLow" onclick="BuzzerValAndFetch();">BUZZER FREQUENCY</button>
                    
                    </td>
                    
                    <script>
                    function BuzzerValAndFetch() {
                        // Get the value from the input field
                        var userValue = document.getElementById('BuzzerValue').value;
                        
                        // Check if the user entered a valid number
                        if (!isNaN(userValue) && userValue.trim() !== "") {
                            // Fetch request with the user-provided value
                            fetch(document.location.origin + '/control?var=buzzerfreq&val=' + userValue + '&cmd=0')
                                .then(response => response.json())
                                .then(data => console.log(data))
                                .catch(error => console.error('Error:', error));
                        } else {
